...
1. [Тестирование модулей (ErisPulse-Testing)](testing.md) - TestBot, фабрика событий и assert-интерфейс

### Руководство по публикации

- [Руководство по публикации и магазину модулей](publishing.md) - Публикация вашего проекта на PyPI и в магазин модулей ErisPulse
