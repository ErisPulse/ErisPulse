...
- [Ownership (owner) System](ownership.md) - Resource ownership and automatic cleanup: owner context mechanism, resource ownership overview, unload cleanup sequence, and design boundaries
- [Interaction Session System](interaction.md) - wait_reply / session timer / multi-path waiting / session mutual exclusion lease / inbox / message transaction / link tracing
- [Inter-Module Communication](module-communication.md) - RPC protocol (module.call), service contracts and directories, directed events, cold start replay, and event idempotency deduplication
