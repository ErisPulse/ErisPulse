...
- [Lazy Loading System](lazy-loading.md) - Working principle, configuration, and event-driven lazy activation (activate_on) of the lazy loading module system
- [Unified Control Plane (scope)](scope.md) - Five-dimensional permission control: module availability / event access / command ACL / text filtering / parameter override
...
- [SQL Query Builder](sql-builder.md) - General-purpose SQL chainable query builder and storage backend abstraction
