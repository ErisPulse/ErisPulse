...
> Note, the current directory is under development, and the directory structure and content may change at any time.

ErisPulse is an extensible multi-platform message processing framework that supports interaction with different platforms via adapters, providing a flexible module system for feature extension.

> Encountering terms you don't understand? Check the [Glossary](terminology.md) for easy-to-understand explanations.

## Documentation Navigation

### Quick Start

- [Quick Start Guide](quick-start.md) - Getting started guide for installing and running ErisPulse

### Getting Started

If you are using ErisPulse for the first time, it is recommended to read in the following order:

1. [Getting Started Overview](getting-started/README.md)
2. [Creating Your First Bot](getting-started/first-bot.md)
...
- [Configuration File Description](user-guide/configuration.md)
...
- [Platform Features Description](platform-guide/README.md)
...
ErisPulse supports two development modes:

### 1. Module Development (Recommended)

Create independent module packages and install them via a package manager. This method facilitates distribution and management and is suitable for publicly released features.

### 2. Embedded Development

Directly embed ErisPulse code into the project without creating independent modules. This method is suitable for rapid prototyping or internal project-specific features.
...
# Run SDK and keep running | Needs to run in async environment
...
- Technical Discussion: Check Discussions
