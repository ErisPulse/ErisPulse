...
本ガイドは、カスタムモジュールやアダプターを開発し、ErisPulseの機能を拡張する際に役立ちます。
...
**入門ガイド：** [モジュール開発入門](modules/getting-started.md)

### アダプター開発

**適用シナリオ：**
- 新しいメッセージングプラットフォームへの接続
- クロスプラットフォーム通信の実装
- プラットフォーム固有機能の提供
...
**入門ガイド：** [アダプター開発入門](adapters/getting-started.md)
...
- `examples/example-module/` - モジュールの例
- `examples/example-adapter/` - アダプターの例

### 開発モード

ホットリロードモードを使用して開発します。
