...
| **發佈** | [發佈與模組商店](developer-guide/publishing.md) | 將作品發佈到 PyPI 和模組商店 |
...
| [模組間通信](advanced/module-communication.md) | RPC 協議化（module.call）、meta.services 服務契約與目錄、定向事件 emit_to、冷啟動回放、事件冪等去重 |
...
| [ErisPulse-Takumi](ecosystem/takumi.md) | 圖片渲染（HTML / 節點樹 / SVG / 動畫，內建中英文字體） |
