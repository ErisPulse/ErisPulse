# ErisPulse 文檔
> 注意，當前目錄處於開發階段，目錄結構和內容可能隨時變化

ErisPulse 是一個可擴展的多平台訊息處理框架，支援透過適配器與不同平台進行交互，提供靈活的模組系統用於功能擴展。
...
- [安裝和配置](user-guide/installation.md)
...
- [模組開發最佳實務](developer-guide/modules/best-practices.md)
...
- [適配器開發最佳實務](developer-guide/adapters/best-practices.md)

#### 擴展開發

- [CLI 擴展開發](developer-guide/extensions/cli-extensions.md)
...
- [發送方法規範](standards/send-method-spec.md)

### 進階主題

- [延遲載入系統](advanced/lazy-loading.md)
...
建立獨立的模組套件，透過套件管理員安裝使用。這種方式便於發布和管理，適合公開發布的功能。
