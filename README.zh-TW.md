...
靈活的插件系統支持運行時熱插拔——安裝/卸載/啟用/禁用模組無需重啟進程，像搭積木一樣組裝機器人能力
...
開發循環從重啟 10 秒縮短到 0.5 秒——保存文件即生效，開發調試體驗接近解釋型腳本語言
...
| `ERISPULSE_DASHBOARD_TOKEN` | 空 | Dashboard 登錄令牌 |
...
| <img src=".github/assets/adapter_logo/yunhu.png" height="20" alt="Yunhu" /> [雲湖使用者](https://github.com/wsu2059q/ErisPulse-YunhuUserAdapter) | 基於雲湖使用者協議的接入適配器 |
